...
class MPL3115A2:
    def __init__(self, addr=MPL3115A2_DEFAULT_ADDRESS, channel=I2C_DEFAULT_CHANNEL):
        self.__addr = addr
        self.__bus = SMBus(channel)
        self.__bus.write_byte_data(self.__addr, PT_DATA_CFG, DREM | PDEFE | TDEFE)
    ...
    def set_altitude(self, altitude):
        ...
        self.__bus.write_byte_data(self.__addr, OFF_H,
    ...
    def read_altitude(self):
        ...
        alt_int = int.from_bytes([alt_data[0], alt_data[1]], byteorder='big', signed=True)
